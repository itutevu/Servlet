...
<div class="container">
	...
	<nav id="affix1" class="navbar navbar-inverse" data-spy="affix" data-offset-top="280">
		...
		<div id="forum1" class="col-md-9">
					...
					<ul class="list-group">
						...
						<li>
							<div class="form-group">
								...
								<div class="col-sm-10">
									<input type="text" class="form-control" placeholder="Scott">
								</div>
							</div>
						</li></br>
						<li>
							<div class="form-group">
								...
								<div class="col-sm-10">
									<input type="text" class="form-control" placeholder="102-NewYork-USS-World!!!">
								</div>
							</div>
						</li></br>
						<li>
							<div class="form-group">
								...
								<div class="col-sm-10">
									<input type="text" class="form-control" placeholder="NewYork">
								</div>
							</div>
						</li></br>
						<li>
						...
						<li>
							<div class="form-group">
								...
								<div class="col-sm-10">
									<input type="text" class="form-control" placeholder="+8421312312312">
								</div>
							</div>
						</li></br>
						<li>
							<div class="form-group">
								...
								<div class="col-sm-10">
									<input type="text" class="form-control" placeholder="Richard***@gmail.com">
								</div>
							</div>
						</li></br>
					</ul>
			...
			<center>
			<div class="form-group">
				<a href="personalinfo.jsp" class="btn btn-default">Save</a>
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<div class="input-group">
  										<input type="text" class="form-control" placeholder="11" aria-describedby="basic-addon2">
