  		...
  		<div class="container-fluid">
    		<div class="navbar-header">
        		<button type="button" class="navbar-toggle" data-toggle="collapse" data-target="#myNavbar">
      			...
      			<a class="navbar-brand" style="color: white; width: 132px;font-size: 20px;" href="HOME.jsp">HOME</a>
    		</div>
    		<div>
        			...
        			<ul class="nav navbar-nav">
				        ...
				        <li class="dropdown"><a style="color: white; width: 132px;font-size: 18px;" class="dropdown-toggle" data-toggle="dropdown" href="#">Online Test<span class="caret"></span></a>
            				<ul style="color: white;" class="dropdown-menu">
              					<li><a href="webToeic1.1.jsp" class="btn">Toeic 250-450</a></li>
		...
		<div id="forum1" class="col-md-9">
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<span class="h5"><a href="Vocab-Basic.jsp" target="_blank">Basic Vocabularys</a></span></br>
					<span class="h5"><a href="#" target="_blank">Animals</a></span></br>
					<span class="h5"><a href="#" target="_blank">Household items</a></span></br>
					
					<span class="h5"><a href="#" target="_blank">Transport</a></span></br>
				</div>
			</div>
			<div class="form-group" style="text-align: right;padding-top:10px;padding-bottom: 10px">
				<a href="Home.jsp" class="btn btn-default pull-left" role="button">Back</a>
			</div>
		</div>
