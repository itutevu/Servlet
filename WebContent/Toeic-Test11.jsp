...
<body>
	<%
		...
		String mucthi="";
		if(request.getParameter("mucthi")!=null){
			mucthi=request.getParameter("mucthi");
		}
	%>
	<div id="headingpic">
		<div class="row">
        			...
        			<ul class="nav navbar-nav">
				        ...
				        <li class="dropdown"><a style="color: white; width: 150px;font-size: 20px;" class="dropdown-toggle" data-toggle="dropdown" href="#">Online Test<span class="caret"></span></a>
            				<ul style="color: white;" class="dropdown-menu">
              				    <li><a href="Toeic-Test11.jsp?mucthi=<%=1 %>" class="btn">Toeic 250-450</a></li>
              					<li><a href="Toeic-Test11.jsp?mucthi=<%=2 %>" class="btn">Toeic 450-650</a></li>
              					<li><a href="Toeic-Test11.jsp?mucthi=<%=3 %>" class="btn">Toeic 650-950</a></li>
            				</ul>
          				</li>
		...
		<div id="forum1" class="col-md-9">
			<div class="panel panel-default">
				<div class="panel-heading">
					<h1 class="panel-title">Bảng xếp hạng điểm số(250-450)</h1>
				</div>
				<div class="panel-body">
				<ul>
					<li style="display: inline; font-size: 26px;">
						<span><span class="col-md-3">1. Thành viên:</span> <a class="col-md-6" href="zing.vn">sad</a>  <span class="col-md-3"> Điểm số: 450</span></span>
					</li>
					<li style="display: inline; font-size: 26px;">
						<span><span class="col-md-3">2. Thành viên:</span> <a class="col-md-6" href="zing.vn">sad</a>  <span class="col-md-3"> Điểm số: 450</span></span>
					</li>
				</ul>
				</div>
			</div><br>
			<div class="panel panel-default">
				<div class="panel-heading">
					<h1 class="panel-title">Danh sách các đề thi</h1>
				</div>
				<div class="panel-body">
				<ul>
				<%
					for(ListDeThi ls:listDeThiDAO.getListDeThi(Integer.parseInt(mucthi))){
				%>
					<li style="display: inline; font-size: 25px;">
						<span>
							<span class="col-md-6">Name:<a href="ádsad"><%=ls.getName() %></a></span>
							<span class="col-md-4">Người up:<a href="linknguoiup"><%=ls.getNguoiUp() %></a></span>
							<a href="TestOl.jsp?mabaitest=<%=ls.getMaBaiTest() %>">Test now</a><br>
						</span>
					</li> 
					<%} %>
				</ul>
