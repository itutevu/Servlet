	...
	<div id="forumchung" class="col-md-12">
    	<div id="forum1" class="col-md-9">
        	...
        	<div class="panel-heading">
          		<h1 class="panel-title">TOEIC TEST</h1>
        	</div>
      		</div>
      		<div class="panel panel-default">
        	<div class="panel-heading">
          		<h1 class="panel-title">TOEIC CORSER</h1>
        	</div>
        	<div class="panel-body">
          		<button class="btn btn-default btn-sm pull-left" data-target="#testModal" data-toggle="modal">Toeic 250-450</button></br>
              			...
              			<div class="modal-content">
                			<div class="modal-header">
                  			...
                  			<div class="panel-default">
                    			<div class="panel-heading">
                      				<h1 class="panel-title">Test Content</h1>
                    			</div>
                    		<div class="panel-body">
                      			<h5><I>time 2 hours</h5></I>
                      			<h5><I>Part A : Listening (100 question/45 mins)</h5></I>
                      			<h5><I>Part A : Reading (100 question/75 mins)</h5></I>
                      			<h5><I>Multiple-choice</I></h5>
                    		</div>
                  		</div>
                	</div>
                <div class="modal-footer">
                	<div id="btnToeic250-450">
                  		<div class="form-group">
                    		<a href="Toeic-Test2.jsp" class="btn btn-default">Test now</a>
          ...
          <button class="btn btn-default btn-sm pull-left" data-target="#testModal" data-toggle="modal">Toeic 450-650</button></br>
          <div class="modal" id="testModal" tabindex="-1">
            <div class="modal-dialog">
              <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-footer">
                <div id="btnToeic450-650">
                  <div class="form-group">
                    <a href="webToeic4.jsp" class="btn btn-default">Test now</a>
                      <button type="submit" class="btn btn-default" data-dismiss="modal">No</button>
                </div>
                </div>
                </div>
          	...
          	<button class="btn btn-default btn-sm pull-left" data-target="#testModal" data-toggle="modal">Toeic 650-990</button>
          	<div class="modal" id="testModal" tabindex="-1">
            <div class="modal-dialog">
              <div class="modal-content">
                <div class="modal-header">
      	...
      	<div class="panel panel-default">
        <div class="panel-heading">
          <h1 class="panel-title">TOEIC WITH EXPLAINTION</h1>
        </div>
        <div class="panel-body">
          <span class="h5"><a href="https://www.google.com.vn/?gfe_rd=cr&ei=XNzoV8OMPNLbugSXmojACA&gws_rd=ssl">Conversation</a></span></br>
          <span class="h5"><a href="https://www.google.com.vn/?gfe_rd=cr&ei=XNzoV8OMPNLbugSXmojACA&gws_rd=ssl">Talk</a></span></br>
          <span class="h5"><a href="https://www.google.com.vn/?gfe_rd=cr&ei=XNzoV8OMPNLbugSXmojACA&gws_rd=ssl">Listen</a></span>
          <span class="h5"><a href="https://www.google.com.vn/?gfe_rd=cr&ei=XNzoV8OMPNLbugSXmojACA&gws_rd=ssl">Text Completion</a></span></br>
        </div>
      	</div>
    </div>
