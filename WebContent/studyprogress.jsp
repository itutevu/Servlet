		...
		<div id="forum1" class="col-md-9">
			<div class="panel panel-default">
				<div class="panel-heading">
					<h1 class="panel-title"><img src="study.png" height="38" width="38"> STUDY PROGRESS</h1>
				</div>
				<div class="panel-body">
					<div class="panel">
  					...
  					<div class="panel-group">
			            ...
			            <div class="panel-body">         
			            	<ul class="nav nav-tabs">
				                <li class="active"><a data-toggle="tab" href="#home"><strong>Writing Test</strong></a></li>
				                <li><a data-toggle="tab" href="#menu1"><strong>Listenning Test</strong></a></li>
			                ...
			                <div id="home" class="tab-pane fade in active">
			                    ...
			                    <tbody>
			                      	<tr>
			                        	<td>
			                        		<form>				                    
						                     	<label><a href="Xem Tai Lieu.jsp">Writing test no.1</a>&nbsp;&nbsp; <a href ="#"><span class="glyphicon glyphicon-repeat"></span></a></label>
						                   		 </div>
						                   	</form>
						                </td>
				                        <td>7.5</td>
			                     	...
			                     	<tr>
			                       		<td>
			                       			<form>			                   
							                    <label><a href="#">Writing test no.2</a>&nbsp;&nbsp; <a href ="#"><span class="glyphicon glyphicon-repeat"></span></a></label>
											</form>
										</td>
				                        <td>6</td>
				                        <td>11/02/2016</td>				                      
							        ...
							        <tr>
			                      		<td>
			                      	  		<form>
			                    				<label><a href="#">Writing test no.3</a>&nbsp;&nbsp; <a href ="#"><span class="glyphicon glyphicon-repeat"></span></a></label>
			                    			</form>
			                    		</td>
			                        <td>9</td>
			                        <td>13/02/2016</td>			                    
			                ...
			                <div id="menu1" class="tab-pane fade">
			                    ...
			                    <tbody>
			                      	<tr>
			                        	<td>
			                        		<form>				                    
						                     	<label><a href="Xem Tai Lieu.jsp">Listenning test no.1</a>&nbsp;&nbsp; <a href ="#"><span class="glyphicon glyphicon-repeat"></span></a></label>
						                   		 </div>
						                   	</form>
						                </td>
				                        <td>5</td>
			                     	...
			                     	<tr>
			                       		<td>
			                       			<form>			                   
							                    <label><a href="#">Listenning test no.2</a>&nbsp;&nbsp; <a href ="#"><span class="glyphicon glyphicon-repeat"></span></a></label>
											</form>
										</td>
				                        <td>4</td>
				                        <td>11/02/2016</td>				                       
							        ...
							        <tr>
			                      		<td>
			                      	  		<form>
			                    				<label><a href="#">Listenning test no.3</a>&nbsp;&nbsp; <a href ="#"><span class="glyphicon glyphicon-repeat"></span></a></label>
			                    			</form>
			                    		</td>
			                        <td>5</td>
			                        <td>11/03/2016</td>			                      
